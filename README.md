...
4.  **☁️ Backup Configuration** - Set up Telegram and Google Drive backups.
5.  **🔄 Auto-Update** - Enable or disable automatic updates.
6.  **✅ DNS Verification** - The script confirms your domain is pointed correctly.
7.  **🐳 Docker Installation** - Installs Docker and all required dependencies.
8.  **🏗️ Build & Deploy** - Builds the custom Docker images and starts the services.
9.  **🔒 SSL Setup** - Automatically issues a free SSL certificate.
